...
-- Field module, dataype module, then main which controls both. Can fields still be updated correctly? could work better. 
-- Declare actions in datatype, then in main use datatype.actions? 
