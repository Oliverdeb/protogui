...
Elm.Characteristics = Elm.Characteristics || {};
Elm.Characteristics.make = function (_elm) {
   "use strict";
   _elm.Characteristics = _elm.Characteristics || {};
   if (_elm.Characteristics.values)
   return _elm.Characteristics.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var addInput = F2(function (address,data) {
      ...
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.value(data.ip)
   ...
   var showInputs = F2(function (address,data) {
      return A2($Html.div,
      _U.list([]),
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A3($Html$Lazy.lazy2,showInputs,address,model.data)
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,AddInput)]),
              _U.list([$Html.text("Add IP")]))]))]));
   });
   var NoOp = {ctor: "NoOp"};
   var Data = F2(function (a,b) {    return {ip: a,id: b};});
   var Model = F2(function (a,b) {
      return {numOfInputs: a,data: b};
   });
   return _elm.Characteristics.values = {_op: _op
                                        ,init: init
                                        ,update: update
                                        ,view: view
                                        ,Model: Model
